...
/*
 * A partir de este punto, nuevas primitivas agregadas pensando en su utilización en hash,
 * pero siendo implementadas de manera abstracta permitiendo su reutilización en otras 
 * implementaciones que las requieran.
 */


/*
 * Recorre la la lista elemento a elemento aplicando la funcion comparador con
 * el elemento actual y el elemento recibido como datos, respectivamente.
 * En caso de devolver true la comparación, reemplaza el elemento actual
 * por el elemento recibido, y lo actualiza en la referencia de elemento_anterior recibida.
 * En caso de no devolver nunca true en las iteraciones, al llegar al final se inserta
 * el elemento como uno nuevo.
 * 
 * En caso de error, devuelve NULL. Caso contrario se devolverá la lista.
 */
lista_t* lista_insertar_o_actualizar(lista_t* lista, void* elemento, bool (*comparador)(void* elemento_actual, void* elemento_nuevo), void** elemento_anterior);

/*
 * Recorre la lista elemento a elemento en búsqueda de un elemento específico, haciendo uso de la funcion
 * comparador, la cual devuelve true en caso de ser el objeto a quitar, o false en caso de continuar.
 * 
 * Elimina el primero elemento encontrado haciendo uso del comparador y devolviéndolo,
 * o en caso de no encontrarse, no hace nada devolviendo NULL.
 *
 * La función comparadora recibe el elemento, y el auxiliar recibido respectivamente.
 */
void* lista_quitar_especifico(lista_t* lista, bool (*comparador)(void* elemento, void* aux), void* aux);


lista_t* lista_insertar_si_no_existe(lista_t* lista, void* elemento, bool (*comparador)(void*, void*));
